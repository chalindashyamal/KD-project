...
const routes = [
  ...
  { label: "Vitals", href: "/staff/vitals" },
  { label: "Medications", href: "/staff/medications" },
  { label: "Dialysis", href: "/staff/dialysis" },
      ...
      <div className="flex-1 flex items-center">
        ...
        {isSearchOpen ? (
          <div className="flex items-center w-full md:w-auto md:ml-4">
            <Input placeholder="Search patients, tasks..." className="w-full md:w-64 h-9 ml-auto" autoFocus />
